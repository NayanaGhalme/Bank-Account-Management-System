...
public void close(){
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        // Get input values
        String cardno = t1.getText().trim();
        String pin=t2.getText().trim();
           System.out.println("values of t1 and t2 are ======>"+cardno+"" +pin);
...
// Prepare the statement (assuming 'st' is a PreparedStatement)
PreparedStatement pst = cn.prepareStatement(query);
pst.setString(1, cardno);  // Set the card number
pst.setString(2, pin);      // Set the pin
...
ResultSet resultset = pst.executeQuery();
        ...
        if (resultset.next()) {
            // Close the current window and open the transaction window
            setVisible(false);
            new Transaction(pin);
        } else {
    ...
    private static class personal_info {
